...
namespace Hook.Data
{
    ...
    public class RepositoryFactories
    {
        ...
        /// </remarks>
        private IDictionary<Type, Func<DbContext, object>> GetCodeHookFactories()
        {
            return new Dictionary<Type, Func<DbContext, object>>
                {
                   {typeof(IFeedRepository), dbContext => new FeedRepository(dbContext)},
        ...
        {
            _repositoryFactories = GetCodeHookFactories();
        }
